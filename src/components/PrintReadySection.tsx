        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[#8A3FFC] font-semibold">Print & Digital</span>
            </div>
            ...
            <p className="text-lg text-[#444] mb-8 leading-relaxed">
              Create printables like posters, cards, brochures, and send them directly to printers or download at home.
            </p>

            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3">
                <FileText className="text-[#8A3FFC]" size={20} />
                <span className="text-[#444]">High-resolution PDF exports</span>
              </div>
              <div className="flex items-center gap-3">
                <Printer className="text-[#8A3FFC]" size={20} />
                <span className="text-[#444]">Direct printer integration</span>
              </div>
              <div className="flex items-center gap-3">
                <Download className="text-[#8A3FFC]" size={20} />
                <span className="text-[#444]">Multiple format downloads</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-6">
                <div className="bg-white rounded-xl shadow-lg p-4 transform rotate-3 hover:rotate-0 transition-transform duration-300">
                  ...
                  <div className="text-sm font-medium text-[#121212]">Business Card</div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-4 transform -rotate-2 hover:rotate-0 transition-transform duration-300">
                  ...
                  <div className="text-sm font-medium text-[#121212]">Mobile Mockup</div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-4 transform -rotate-1 hover:rotate-0 transition-transform duration-300">
                  <div className="w-full h-48 bg-gradient-to-br from-purple-400 via-[#8A3FFC] to-[#4F82FF] rounded-lg mb-3 flex items-center justify-center">
                    <div className="text-white text-center">
                      <div className="text-2xl font-bold mb-1">POSTER</div>
                      <div className="text-sm opacity-80">Ready to Print</div>
                    </div>
                  </div>
                  <div className="text-sm font-medium text-[#121212]">Event Poster</div>
                  <div className="text-xs text-gray-500">300 DPI</div>
                </div>
              </div>
            </div>
