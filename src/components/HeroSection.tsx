  ...
  return (
    <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 left-40 w-80 h-80 bg-gradient-to-r from-purple-400 to-blue-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[600px]">
            <div className="relative z-10 h-full">
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500 h-full flex flex-col">
                <div className="bg-gradient-to-br from-purple-100 to-blue-100 rounded-xl p-6 mb-6 flex-1">
                  ...
                  {/* Enhanced content with relevant text */}
                  ...
                  {/* Central video mockup with play/pause */}
                  <div className="relative bg-gradient-to-br from-pink-200 to-purple-200 rounded-lg h-40 flex items-center justify-center mb-6">
                    <div className="absolute inset-0 bg-black/10 rounded-lg"></div>
                    <div className="relative z-10 w-16 h-16 bg-white/90 rounded-full flex items-center justify-center animate-pulse">
                      <Pause className="text-purple-600" size={24} />
                    </div>
                    <div className="absolute top-4 left-4 text-white/80 text-sm font-medium">Brand Video</div>
                    <div className="absolute bottom-4 right-4 text-white/80 text-xs">2:34</div>
                  </div>
            ...
            <div className="absolute inset-0 -z-10">
              <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-br from-purple-300 to-blue-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"></div>
              <div className="absolute bottom-0 left-0 w-72 h-72 bg-gradient-to-br from-blue-300 to-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse animation-delay-2000"></div>
            </div>
          </div>
        </div>
      </div>
